class ShipFrom < ActiveHash::Base
  self.data = [
    ...
    { id: 4, name: '岩手県' }, { id: 5, name: '秋田県' }, { id: 6, name: '山形県' },
    { id: 7, name: '宮城県' }, { id: 8, name: '福島県' }, { id: 9, name: '茨城県' },
    ...
    { id: 25, name: '岐阜県' }, { id: 26, name: '滋賀県' }, { id: 27, name: '京都府' },
    { id: 28, name: '大阪府' }, { id: 29, name: '兵庫県' }, { id: 30, name: '奈良県' },
    { id: 31, name: '和歌山県' }, { id: 32, name: '岡山県' }, { id: 33, name: '広島県' },
    { id: 34, name: '山口県' }, { id: 35, name: '鳥取県' }, { id: 36, name: '島根県' },
